        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 backdrop-blur-sm">
            <div className="bg-white rounded-lg shadow-xl border border-gray-200 w-[420px] overflow-hidden">
                ...
                <div className="px-4 py-2.5 bg-gradient-to-r from-blue-50 to-blue-100 border-b border-blue-200">
                    <h2 className="text-sm font-semibold text-gray-800">Save Terminal Bookmark</h2>
                </div>
                ...
                <form onSubmit={handleSubmit} className="px-4 py-3">
                    ...
                    <div className="mb-3">
                        ...
                        <textarea
                            ...
                            className="w-full px-2.5 py-1.5 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors font-mono resize-none"
                    ...
                    <div className="mb-3">
                        ...
                        <textarea
                            ...
                            className="w-full px-2.5 py-1.5 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none"
